...
/**
 * @Auther: li
 * @Date: 2022/5/19 - 05 - 19 - 13:45
 * @Description: com.msb.generator
 * @version: 1.0
 */
...
// 构建一个代码生成对象
        ...
        gc.setOutputDir("E:\\Git\\msb-dongbao-mall-parent\\msb-dongbao-mall-parent-v1\\msb-dongbao-mall-service\\msb-dongbao-ums\\src\\main\\java");
        gc.setAuthor("LR");
